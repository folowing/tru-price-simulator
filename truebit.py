...
def init(initial_mint, initial_reserve):
  ...
  eth.call(deployer, trutoken_address, 'grantRole', [(decode_hex('0x9f2df0fed2c77648de5860a4cc508cd0818c85b8b8a1ab4ceeef8d981c8956a6'), 'bytes32'), (purchase_address, 'address')])
